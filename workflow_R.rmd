...
title: |
  ...
  Bioinformatics and basic setups for MAC2024
...
<strong>**In this workflow the main steps for 16S rRNA gene amplicon data analysis in Qiime2 and R are presented. This toturial is prepared for MAC 2024 course at the University of Copenhagen, department of Food Science.**\n 
...
```{python, inference}
## Exploring the reads
zcat ./data/MAC2024_iSeq001_S1_L001_R2_001.fastq.gz 


zcat ./data/MAC2024_iSeq001_S1_L001_R2_001.fastq.gz | grep ^@FS10000714| cut -d ":" -f1 | wc -l
...
zcat ./data/MAC2024_iSeq001_S1_L001_R2_001.fastq.gz | head
...
seqkit stats ./data/MAC2024_iSeq001_S1_L001_R2_001.fastq.gz
...
qiime tools import \
  ...
  --input-path ~/MAC2024/manifest.tsv \                    # link to the folder in which my manifest file is located
  --output-path ~/MAC2024/demuxed_MAC23.qza                 # link to the path where I want my demultiplexed data to be exported in
...
setwd("/home/hackion/Dropbox/Old-2gb/postdoc/mac2024")
...
bioc.pkg <- c("phyloseq", "DESeq2", "ggtree", "vsn")

cran.pkg <- c("tidyverse", "readr", "ape", "picante", "glue", "vegan", "devtools", "ggrepel", "reshape2", "BiocManager",
              "ggnetwork", "DT", "lme4", 'broom', "pheatmap", "patchwork")
...
"vegan", "ggtree", "devtools", "ggrepel", "reshape2", 
"pheatmap", "glue", "ape", "readr", "vsn", "vegan", "patchwork")
...
```{r}
ft = read_tsv('./MAC2024.github.io/data/illumina/Results_MAC23_MAC96_S96/OTU-tables/zOTU_table_GG.txt' ) %>% data.frame()
...
tr$tip.label %>% length()
tr = ggtree::read.tree('./MAC2024.github.io/data/illumina/Results_MAC23_MAC96_S96/zOTU.tree') 
...
# Merging data
pst = phyloseq(otu_table(ft, taxa_are_rows = TRUE), 
          tax_table(tx),
          phy_tree(tr), 
          sample_data(mt),
          refseq(seqs))
...
[Feature table](https://github.com/farhadm1990/MAC2024.github.io/blob/main/data/count_matrix.tsv)

[Taxonomy table](https://github.com/farhadm1990/MAC2024.github.io/blob/main/data/taxonomy.tsv)

[Meta data](https://github.com/farhadm1990/MAC2024.github.io/blob/main/data/metadata.txt)

[Representative sequences](https://github.com/farhadm1990/MAC2024.github.io/blob/main/data/rep_seqs.fasta)

[Phylogenetic tree](https://github.com/farhadm1990/MAC2024.github.io/blob/main/data/tree.nwk)

[ONT fastq files](https://github.com/farhadm1990/MAC2024.github.io/tree/main/data/fastq_mac)

[Illumina results](https://github.com/farhadm1990/MAC2024.github.io/tree/main/data/illumina/Results_MAC23_MAC96_S96)
